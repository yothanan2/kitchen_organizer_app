...
class _EditDishScreenState extends ConsumerState<EditDishScreen> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(editDishControllerProvider(widget.dish));
    final controller = ref.read(editDishControllerProvider(widget.dish).notifier);
                ...
                children: [
                  ...
                  ...dish.ingredients.map((ingredient) {
                    ...
                    return ListTile(
                      ...
                      trailing: IconButton(icon: const Icon(Icons.delete), onPressed: () => controller.removeIngredient(index)),
                    );
                  }),
